...
describe("/api/customers", () => {
  ...
  describe("GET /", () => {
    it("Should return a list with 2 customers", async () => {
      ...
      expect(res.body.data.some((c) => c.username === 'customer1')).toBeTruthy();
      expect(res.body.data.some((c) => c.username === 'customer2')).toBeTruthy();
    });
  });
  describe("GET /:id", () => {
    ...
    it("Should return 200 if valid id is provided", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.success).toBe;(true);
      expect(res.body.data).toHaveProperty('username', 'customer1');
    });
  });
  describe("GET /me", () => {
  ...
  describe("POST /", () => {
    ...
    it("Should return 200 if correct customer object is sent", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.success).toBe(true);
      expect(res.body.data).toHaveProperty('email', 'customer1@gmail.com');
    });
  });
  describe("PUT /me", () => {
    beforeEach(async () => {
    ...
    it("Should return 200 if valid updated values are sent", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.success).toBe(true);
      expect(res.body.data).toHaveProperty('username', 'updated username');
    });
  });
  ...
  describe("DELETE /me/remove-fav_restaurants/:id", () => {
    ...
    it("Should return 200 if restaurant is removed from the fav list", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.success).toBe(true);
      expect(res.body.data.removed).toHaveProperty('name', 'restaurantTest1')
      const updatedCustomer = await Customer.findById(customer._id);
  ...
  describe("DELETE /me/remove-fav_bartenders/:id", () => {
    ...
    it("Should return 200 if bartender is removed from the fav list", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.success).toBe(true);
      expect(res.body.data.removed).toHaveProperty('username', 'bartenderTest1')
      const updatedCustomer = await Customer.findById(customer._id);
