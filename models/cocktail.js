...
const cocktailSchema = new mongoose.Schema({
  ...
  image: {
    ...
    imgPath: {
      ...
      required: true,
      default:
        "https://images.unsplash.com/photo-1509669803555-fd5edd8d5a41?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80",
    },
  },
  owner: {
...
cocktailSchema.methods.validateCocktail = function (cocktail) {
...
cocktailSchema.methods.validateImage = function (img) {
